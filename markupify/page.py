...
class HTMLPage:
    ...
    def __init__(
        ...
        ### Args:
             lang (str, optional): The language of the HTML page (Default to "en").
             head (str, optional): The head section of the HTML page (Default to "<head></head>").
             body (str, optional): The body section of the HTML page (Default to "<body></body>").
        ### Attributes:
             lang (str): The language of the HTML page.
